...
namespace BackSeam
{
    ...
    public partial class ViewModelCreatInterview : BaseViewModel
    {
        ...
        public static void LoadCreatInterview()
        {
            ...
            if(MapOpisViewModel.ModelCall !=null )
            {
                if(MapOpisViewModel.ModelCall.Length != 0) if (MapOpisViewModel.ModelCall == "ModelColectionInterview") nawpathcontroler = Completedcontroller;
            }
